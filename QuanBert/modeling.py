...
def attention_layer(from_tensor,
  ...
  if attention_mask is not None:
    ...
    attention_scores=tf.cast(attention_scores, tf.float16)
  ...
  attention_probs=tf.cast(attention_probs,tf.float16)
  value_layer=tf.cast(value_layer,tf.float16)
    ...
    with tf.variable_scope("layer_%d" % layer_idx):
      ...
      with tf.variable_scope("attention"):
        ...
        with tf.variable_scope("output"):
          ...
          layer_input = tf.cast(layer_input, tf.float16)
