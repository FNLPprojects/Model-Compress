...
from models.modeling import TinyBertForPreTraining
from transformers import BertModel, BertTokenizer, BertConfig, AdamW, get_linear_schedule_with_warmup,get_constant_schedule
    ...
    for epoch in trange(int(args.num_train_epochs), desc="Epoch"):
        ...
        with tqdm(total=len(train_dataloader), desc="Epoch {}".format(epoch)) as pbar:
            for step, batch in enumerate(tqdm(train_dataloader, desc="Iteration", ascii=True)):
                ...
                teacher_outputs = teacher_model(input_ids=input_ids, attention_mask=input_mask, token_type_ids =segment_ids)
