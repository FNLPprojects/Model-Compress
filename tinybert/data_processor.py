...
class InputFeatures_tinybert(object):
...
def convert_examples_to_features_tinybert(examples, label_list, max_seq_length,
    ...
    for (ex_index, example) in enumerate(examples):
        ...
        features.append(
            InputFeatures_tinybert(input_ids=input_ids,
