...
from prepro import create_vocabulary, create_data_ids,createdata,create_vocabulary_distil, create_data_ids_distil
from solver import Solver
from model import BiLSTM
#设置参数
flags = tf.app.flags
flags.DEFINE_string('mode', 'distil', "train / test / distil")
flags.DEFINE_integer('vocab_size', 7010, 'size of vocab list')
flags.DEFINE_integer('batch_size', 512, 'size of batch')
...
flags.DEFINE_integer('maxlen', 150, 'max length')
