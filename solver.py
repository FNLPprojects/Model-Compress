...
class Solver(object):
    ...
    def load_data(self, split='train'):
        ...
        if split == 'distil':
            ...
            with open('./ids/sst2/augmented.ids') as fin:
        ...
        if split == 'train':
            with open('./ids/sst2/sentiment.train.1.ids') as fin:
                for line in fin.readlines():
                    text = [int(v) for v in line.strip().split()]
                    texts_data.append(text)
                    labels_data.append(1)
            with open('./ids/sst2/sentiment.train.0.ids') as fin:
                for line in fin.readlines():
                    text = [int(v) for v in line.strip().split()]
                    texts_data.append(text)
                    labels_data.append(0)
        elif split == 'dev':
            with open('./ids/sst2/sentiment.dev.1.ids') as fin:
                for line in fin.readlines():
                    text = [int(v) for v in line.strip().split()]
                    texts_data.append(text)
                    labels_data.append(1)
            with open('./ids/sst2/sentiment.dev.0.ids') as fin:
                for line in fin.readlines():
                    text = [int(v) for v in line.strip().split()]
                    texts_data.append(text)
                    labels_data.append(0)
            ...
            with open('./ids/sst2/sentiment.test.1.ids') as fin:
                for line in fin.readlines():
                    text = [int(v) for v in line.strip().split()]
                    texts_data.append(text)
                    labels_data.append(1)
            with open('./ids/sst2/sentiment.test.0.ids') as fin:
                for line in fin.readlines():
                    text = [int(v) for v in line.strip().split()]
                    texts_data.append(text)
                    labels_data.append(0)
