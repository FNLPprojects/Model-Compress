...
from data_processor import glue_convert_examples_to_features as convert_examples_to_features
...
def train(args, train_dataset, model, tokenizer):
    ...
    if args.train_type == "finetune_teacher":
        ...
        raise ValueError('%s train_type not found' % args.train_type)
...
def main():
    ...
    parser.add_argument("--train_type",
                        ...
                        type=str,
                        required=True,
                        choices=["finetune_teacher","student"],
                        help="finetune teacher model or train student model")
    parser.add_argument("--model_type",
                        default='bert',
                        type=str,
                        help="Model type here only for bert")

    parser.add_argument("--replacing_rate",
                        default=0.5,
                        type=float,
    ...
    parser.add_argument("--scheduler_type",
                        default='none',
                        choices=['none', 'linear'],
                        help="Scheduler function.")
    parser.add_argument("--scheduler_linear_k",
                        default=0,
                        type=float,
                        help="Linear k for replacement scheduler.")
    parser.add_argument("--steps_for_replacing",
                        default=0,
                        type=int,
    ...
    elif args.train_type == "finetune_teacher":
    ...
    # Initialize BERT weights if train student model
    if args.train_type == "student":
